...
Keaktifan dan kontribusi nyata dalam pengerjaan proyek adalah prasyarat mutlak untuk mempertahankan status keanggotaan dan memperoleh sertifikat kelulusan batch. Sanksi administratif dan alur pembinaan anggota yang pasif diatur secara sah merujuk pada [**Anggaran Rumah Tangga (ART) YYZU Pasal 9**](/docs/identity/art).
