---
title: PIC / Ketua Kelompok
description: Detail peran, tanggung jawab, wewenang, dan batasan peran PIC / Ketua Kelompok dalam proyek YYZU.
status: active
...
Peran ini bersifat *project-scoped*, berbeda dengan peran kepengurusan permanen di level divisi YYZU. PIC hanya aktif selama satu project berjalan dan melekat pada satu kelompok tertentu.

## Tujuan
PIC bertanggung jawab dalam mengoordinasikan eksekusi harian kelompoknya, agar project berjalan sesuai scope, timeline, dan kualitas yang telah disepakati pada tahap planning, serta menjadi titik komunikasi utama antara kelompok dan Divisi Product & Project Management.
...
## Batasan Peran
PIC tidak bertanggung jawab atas:
...
- Menentukan kelulusan atau transisi Stage anggota kelompoknya; hal ini tetap menjadi kewenangan Mentor dan SDM Management.
- Menjabat secara permanen di luar durasi project; peran PIC berakhir saat project selesai.
