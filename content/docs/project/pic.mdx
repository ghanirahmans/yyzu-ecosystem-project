...
Peran ini bersifat *project-scoped*, berbeda dengan peran kepengurusan permanen di level divisi. PIC hanya aktif selama satu project berjalan dan melekat pada satu kelompok tertentu.
