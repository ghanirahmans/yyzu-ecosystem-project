...
- **In Review:** Task selesai dikerjakan, menunggu review dari rekan tim atau PIC.
- **Done:** Task telah diverifikasi sesuai Definition of Done.

### 5.1 Sprint Ceremonies (Sesi Wajib per Sprint)
Setiap sprint wajib menjalankan empat ceremony berikut. Seluruh sesi dipimpin oleh PIC dan dihadiri oleh seluruh anggota tim.
...
6. Jika task menghasilkan deliverable yang perlu diketahui Mentor, sudah dikomunikasikan kepada PIC.
...
| :--- | :--- | :--- |
| **Foundation** (Persiapan) | Anggota kelompok mempelajari konsep dasar dan tools standar (Git flow, Figma, project setup) di bawah arahan PIC; Mentor memberikan pembekalan materi. | Kesiapan teknis seluruh anggota tim terverifikasi. |
...
| **Execution & QA** (Pengerjaan) | Pengerjaan task secara fokus. PIC memimpin sinkronisasi berkala. Developer menulis kode dengan Pull Request & Code Review. Deployment berkala ke staging server untuk pengujian bersama. | Aplikasi berfungsi penuh di server staging dan bebas dari bug kritis. |
...
1. **Fase Foundation (Persiapan & Pembekalan):**
   ...
   - Divisi PM melakukan pembentukan kelompok dan menunjuk PIC.
...
2. **Fase Planning & Proposal Pitching (Perencanaan & Pembuktian Ide):**
   ...
   - **Sub-Fase 2B: Proposal Pitching (Penyusunan & Presentasi Ide)**
     ...
     - **Revisi & Finalisasi:** Setelah mendapat persetujuan Mentor, desainer menuntaskan UI di Figma dan developer menyiapkan struktur database/API. PIC memecah fitur menjadi task di Kanban Board.
...
3. **Fase Execution & QA (Pengerjaan & Pengujian):**
   ...
   - PIC melakukan sinkronisasi berkala (daily sync/standup) untuk melacak kendala.
...
- **Linear / Trello / Jira / ClickUp / Notion Board:** Manajemen tugas berbasis Kanban Board untuk memantau status pengerjaan yang dikelola oleh PIC kelompok secara berkala. Kolom minimal yang harus ada:
