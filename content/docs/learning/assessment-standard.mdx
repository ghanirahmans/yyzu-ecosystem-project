...
| Field | Value |
| :--- | :--- |
| **Tipe Dokumen** | Operational Standard |
| **Owner** | Ghaniyyir Rahman Sudarsono (Founder YYZU) |
| **Berlaku untuk** | Semua Mentor, semua track, semua level |
| **Review** | Sebelum dimulainya setiap batch baru atau minimal dua kali dalam satu tahun kalender |
