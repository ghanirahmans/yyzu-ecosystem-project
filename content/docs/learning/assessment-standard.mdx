...
Dokumen ini mengisi gap antara kompetensi (didefinisikan di Kurikulum) dan keputusan sign-off (dilakukan oleh Mentor). Alur review di YYZU menggunakan dua lapisan: **SDM Management** melakukan review internal terlebih dahulu, baru kemudian diteruskan ke Mentor yang relevan atau Mentor lainnya. Ini adalah operasionalisasi dari **Prinsip 2** (Bukti Mendahului Klaim) dan **Prinsip 6** (Progression melalui Demonstrasi) dari [🧭 Prinsip Pembelajaran YYZU](/docs/learning/principles).
...
### Langkah 2: Review Internal oleh SDM Management

Self-assessment dan artefak dikirimkan ke **SDM Management** terlebih dahulu. SDM Management melakukan review internal menggunakan checklist yang relevan di dokumen ini. Tujuannya:
...
Jika artefak lolos review internal SDM Management, dokumen diteruskan ke **Mentor terkait** (atau Mentor lainnya yang tersedia). Mentor membaca review SDM Management dan mereview artefak secara asinkron. Mentor mempersiapkan clarifying questions seperlunya.

Jika artefak belum memenuhi standar, SDM Management mengembalikan ke member dengan feedback untuk perbaikan - **belum sampai ke Mentor**.
...
**Langkah 3: Re-submission** - Member mengajukan ulang dengan self-assessment yang diperbarui, termasuk penjelasan eksplisit tentang apa yang berubah dari submission sebelumnya. Re-submission melewati **SDM Management terlebih dahulu** sebelum diteruskan ke Mentor.
...
2. Dokumen tersebut dikirim ke **SDM Management**
3. SDM Management meninjau artefak dan feedback Mentor secara independen dan mengambil keputusan
4. Jika member masih tidak setuju dengan keputusan SDM Management, eskalasi dapat dilakukan ke **Founder** sebagai final escalation — khusus untuk kasus yang melibatkan inkonsistensi standar atau gap rubrik yang sistemik
...
**Calibration session:** Dilakukan minimal sekali per batch, sebelum batch dimulai. **SDM Management** memfasilitasi review bersama terhadap 2 - 3 contoh artefak - satu yang jelas memenuhi, satu yang jelas tidak memenuhi, dan satu yang borderline. Semua Mentor membuat keputusan independen terlebih dahulu, kemudian mendiskusikan perbedaan.

**Calibration log:** Setiap perbedaan signifikan dalam calibration session dicatat oleh SDM Management. Jika ada perbedaan yang berulang untuk dimensi yang sama, **SDM Management mengusulkan pembaruan rubrik dan Founder menyetujui sebelum perubahan berlaku resmi**.
...
| --- | --- | --- | --- |
| 1.2 | Juli 2026 | Integrasi SDM Management: alur sign-off dua lapisan, re-submission lewat SDM Management, calibration difasilitasi SDM Management; referensi Appendix yang tidak ada dihapus | Ghaniyyir Rahman Sudarsono |
