...
description: "8 prinsip pembelajaran yang menjadi landasan filosofis bagi seluruh aktivitas pembelajaran di ekosistem YYZU."
---
...
Sign-off dari Mentor selalu berdasarkan review terhadap artefak spesifik, bukan kesan umum. Hadir dan aktif berdiskusi tidak cukup untuk lulus. Standar lengkapnya ada di [📐 Assessment Standard YYZU](/docs/learning/assessment).
**Dasar:** Pilar Evidence-Based YYZU; C-BEN (2017).
---
## Prinsip 3 - Proyek sebagai Medium Belajar Utama
Di YYZU, proyek bukan ujian akhir dari proses belajar. Proyek adalah cara belajar itu sendiri. "Pelajari dulu, baru proyek" adalah anti-pattern di sini.
Seluruh validasi kompetensi dilakukan melalui proyek nyata - Mini Project (Beginner), Collaborative Project (Intermediate), Internal Project (Advanced) - bukan kuis atau latihan terisolasi. Dan sebelum membangun apapun, Problem Discovery wajib dilakukan terlebih dahulu karena memahami konteks masalah adalah bagian dari kompetensi itu sendiri.
...
Jika belum siap, member mendapat written feedback yang spesifik dan kesempatan retry. Standar tidak diturunkan, tapi jalannya tetap terbuka. Detail retry mechanism ada di [📐 Assessment Standard YYZU](/docs/learning/assessment).
...
| [📋 Skema Project Management](/docs/operations/project/overview) | Implementasi Prinsip 3, 4, 5 |
| [📈 Skema Mentoring](/docs/operations/mentoring) | Implementasi Prinsip 7 |
| [📐 Assessment Standard YYZU](/docs/learning/assessment) | Operasionalisasi Prinsip 2 and 6 |
---
## Referensi
