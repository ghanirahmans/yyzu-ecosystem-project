...
- [Standar Proyek YYZU](/docs/operations/project/standards) - kriteria kelayakan dan Definition of Done
- [Alur Kerja Proyek](/docs/operations/project/workflow) - workflow pengerjaan proyek
- [Standar Penulisan & Metadata](/docs/reference/writing-guide) - format dan metadata dokumen