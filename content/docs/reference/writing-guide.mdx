---
title: "Panduan Penulisan Dokumen YYZU"
description: Standar penulisan, metadata, gaya penulisan, dan penamaan untuk seluruh dokumentasi YYZU.
---
...
- **Tautan (Links):** Saat mereferensikan dokumen lain, gunakan tautan yang valid. Teks tautan harus merupakan nama resmi dokumen tanpa menggunakan format kode / backticks (contoh: [Kurikulum Member YYZU](/docs/learning/curriculum) - bukan [`Kurikulum Member YYZU`](/docs/learning/curriculum)).
...
- Lihat [Knowledge Architecture YYZU](/docs/learning/knowledge-architecture) untuk detail.
...
- [YYZU Global Terminology Dictionary](/docs/reference/terminology) - Definisi istilah pendidikan
